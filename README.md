...
It allows you to explore hundreds of systems and thousands of games right from your browser popup, add game to favorites, filter by console, play games with a single click
